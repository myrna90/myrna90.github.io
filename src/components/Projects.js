...
class Projects extends React.Component{
    constructor(props){
        ...
        <Card shadow={5} style={{minWidth:"450", margin:"auto"}}>
            ...
            <CardActions border>
            <Button colored href="https://github.com/myrna90/gdl-2019-01-bc-core-cipher" target="_blank" rel="noopener noreferrer">GitHub</Button>
            <Button colored href="https://myrna90.github.io/gdl-2019-01-bc-core-cipher/src/" target="_blank" rel="noopener noreferrer">Live Demo</Button>
            </CardActions>
        ...
        <Card shadow={5} style={{minWidth:"450", margin:"auto"}}>
            ...
            <CardActions border>
            <Button colored href="https://github.com/myrna90/GDL002-data-lovers" target="_blank" rel="noopener noreferrer">GitHub</Button>
            <Button colored href="https://myrna90.github.io/GDL002-data-lovers/src/" target="_blank" rel="noopener noreferrer">Live Demo</Button>
            </CardActions>
            <CardMenu style={{color: "black"}}>
            <IconButton name="share"/>
            </CardMenu>
        ...
        <Card shadow={5} style={{minWidth:"450", margin:"auto"}}>
            ...
            <CardActions border>
            <Button colored href="https://github.com/myrna90/GDL002-social-network" target="_blank" rel="noopener noreferrer">GitHub</Button>
            <Button colored href="https://myrna90.github.io/GDL002-social-network/src/" target="_blank" rel="noopener noreferrer">Live Demo</Button>
            </CardActions>
            <CardMenu style={{color: "black"}}>
            <IconButton name="share"/>
            </CardMenu>
        ...
        <Card shadow={5} style={{minWidth:"450", margin:"auto"}}>
            ...
            <CardActions border>
            <Button colored href="https://github.com/myrna90/GDL-open-house" target="_blank" rel="noopener noreferrer">GitHub</Button>
            <Button colored href="https://monicamun.github.io/GDL-open-house" target="_blank" rel="noopener noreferrer">Live Demo</Button>
            </CardActions>
            <CardMenu style={{color: "black"}}>
            <IconButton name="share"/>
            </CardMenu>
         ...
         <Card shadow={5} style={{minWidth:"450", margin:"auto"}}>
            ...
            <CardActions border>
            <Button colored href="https://github.com/myrna90/rampa-finder" target="_blank" rel="noopener noreferrer">GitHub</Button>
            <Button colored href="http://rampa-finder.herokuapp.com" target="_blank" rel="noopener noreferrer">Live Demo</Button>
            </CardActions>
            <CardMenu style={{color: "black"}}>
            <IconButton name="share"/>
            </CardMenu>
        ...
        <Card shadow={5} style={{minWidth:"450", margin:"auto"}}>
            ...
            <CardActions border>
            <Button colored href="https://github.com/myrna90/GDL002-mobile-game" target="_blank" rel="noopener noreferrer">GitHub</Button>
            {/*<Button colored href="" target="_blank" rel="noopener noreferrer">Live Demo</Button>*/}
            </CardActions>
            <CardMenu style={{color: "black"}}>
            <IconButton name="share"/>
            </CardMenu>
